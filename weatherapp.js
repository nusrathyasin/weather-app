...
if (navigator.geolocation) {
		...
		//Get the data from openweathermap.org
		$.ajax({
			url: 'http://api.openweathermap.org/data/2.5/weather?lat='+Latitude+ '&lon=' +Longitude + "&units=metric" + "&units=imperial"+"&APPID=2c8459c3dbea9a2c30318bd4ac76b3ac",
			type:"GET",
			dataType:"jsonp",
...
var bodyImages = [ /*01d-clearSkyDay*/ '1.gif',
       ...
       '8.gif',
        ...
        /*04n*/
        'https://45.media.tumblr.com/e9de4cab1050e82b56e2460e49f25269/tumblr_nwqbnwVqYQ1tqou9go1_400.gif',
        /*09d-showerRainDay*/
        '9.gif',
        /*09n*/
      ...
      //iterate png number to match up with image
		...
		$("#degF").click(function(){
			...
			$(this).css("color","red");    //current temperature is shown in celsius
			$("#temp").html(tempInF);
		});
		$("#degC").click(function(){
